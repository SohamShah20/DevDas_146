    ...
    const fetchDealer = async () => {
      try {
        const res = await fetch(
          `http://localhost:3001/api/customer/getdealer/${id}`
        );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4 hover:scale-105 transition-transform duration-300 ease-in-out">
            <div className="text-lg font-medium text-gray-700">
              ...
              <p>
                <strong className="text-gray-900">Email:</strong> {dealer.email}
              </p>
              <p>
                <strong className="text-gray-900">City:</strong> {dealer.city}
              </p>
              <p>
